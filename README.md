...
## Supported platforms
- [Amazon Web Services](docs/setup/config/aws.md) -  API Gateway, EC2, Elasticsearch, Elastic Kubernetes Service, DynamoDB, IAM, KMS, Lambda, RDS, Redshift, Route53, S3, Secrets Manager, SQS, STS, Tags
