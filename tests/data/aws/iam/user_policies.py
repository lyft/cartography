...
GET_USER_MANAGED_POLS_SAMPLE = {
    'arn:aws:iam::1234:user/user1': {'arn:aws:iam::1234:policy/user1-user-policy': [{'Sid': 'VisualEditor0',
    'Effect': 'Allow',
  ...
  'arn:aws:iam::aws:policy/AmazonS3FullAccess': [{'Effect': 'Allow',
    'Action': ['s3:*', 's3-object-lambda:*'],
    'Resource': '*'}],
  'arn:aws:iam::aws:policy/AWSLambda_FullAccess': [{'Effect': 'Allow',
 ...
 'arn:aws:iam::1234:user/user3': {'arn:aws:iam::aws:policy/AdministratorAccess': [{'Effect': 'Allow',
    'Action': '*',
    'Resource': '*'}]}}