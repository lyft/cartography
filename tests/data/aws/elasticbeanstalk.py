...
GET_ELASTICBEANSTALK_APPLICATION = [
    {
        ...
        'VersionsList': [
            {
                'ApplicationName': 'Scorekeep',
                'ApplicationVersionArn': 'arn:aws:elasticbeanstalk:us-east-1:000000000000:'
                                         'applicationversion/Scorekeep/scorekeep-version-abcdefgh',
                ...
                'SourceBundle': {
                    'S3Bucket': 'beanstalk-artifacts-jfksadjlffasdkf',
