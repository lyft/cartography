...
def test_sync_ebs_volumes(mock_get_vols, neo4j_session):
    ...
    # Assert
    assert check_nodes(neo4j_session, 'EBSVolume', ['id']) == {
...
def test_sync_ebs_volumes_e2e(mock_get_vols, mock_get_instances, neo4j_session):
    ...
    assert check_nodes(neo4j_session, 'EBSVolume', ['id', 'deleteontermination', 'encrypted']) == {
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-03', True, None),
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-04', True, None),
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-09', True, None),
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-0df', True, None),
    }
    ...
    assert check_nodes(neo4j_session, 'EBSVolume', ['id', 'deleteontermination', 'encrypted']) == {
        ...
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-09', True, None),
        # Added by ebs sync
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-03', True, True),
        ('arn:aws:ec2:eu-west-1:000000000000:volume/vol-0df', True, True),
    }
