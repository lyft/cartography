...
import cartography.intel.hexnode.tenant
...
def start_hexnode_ingestion(neo4j_session: neo4j.Session, config: Config) -> None:
    ...
    common_job_parameters = {
        ...
        "TENANT": config.hexnode_tenant,
    }
    api_session = requests.Session()
    api_session.headers.update({'Authorization': config.hexnode_api_key})

    cartography.intel.hexnode.devices.sync(neo4j_session, api_session, api_url, common_job_parameters)
    cartography.intel.hexnode.users.sync(neo4j_session, api_session, api_url, common_job_parameters)
    cartography.intel.hexnode.policies.sync(neo4j_session, api_session, api_url, common_job_parameters)
    cartography.intel.hexnode.device_groups.sync(neo4j_session, api_session, api_url, common_job_parameters)
    cartography.intel.hexnode.tenant.sync(neo4j_session, api_session, api_url, common_job_parameters)
