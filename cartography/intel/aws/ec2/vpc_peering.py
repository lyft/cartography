...
@timeit
@aws_handle_regions
def get_ec2_vpc_peering(boto3_session: boto3.session.Session, region: str) -> List[Dict]:
    client = boto3_session.client('ec2', region_name=region, config=get_botocore_config())
    return client.describe_vpc_peering_connections()['VpcPeeringConnections']


@timeit
def load_ec2_vpc_peering(neo4j_session: neo4j.Session, data: List[Dict], update_tag: int) -> None:
    ...
    SET requestor_account.lastupdated = {update_tag}
    ...
    SET requestor_vpc.lastupdated = {update_tag}
    ...
    SET requestor_block.lastupdated = {update_tag}
...
@timeit
def cleanup_ec2_vpc_peering(neo4j_session: neo4j.Session, common_job_parameters: Dict) -> None:
...
def sync_vpc_peering(
    ...
    for region in regions:
        ...
        load_ec2_vpc_peering(neo4j_session, data, update_tag)
