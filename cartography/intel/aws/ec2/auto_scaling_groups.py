...
@timeit
def sync_ec2_auto_scaling_groups(neo4j_session: neo4j.Session, aws_stage_ctx: AwsStageContext):
    for region in aws_stage_ctx.current_aws_account_regions:
        ...
        data = get_ec2_auto_scaling_groups(aws_stage_ctx.boto3_session, region)
    ...
    cleanup_ec2_auto_scaling_groups(neo4j_session, aws_stage_ctx.graph_job_parameters)
