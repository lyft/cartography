...
@timeit
def sync_ec2_key_pairs(neo4j_session: neo4j.Session, aws_stage_ctx: AwsStageContext) -> None:
    for region in aws_stage_ctx.current_aws_account_regions:
        ...
        data = get_ec2_key_pairs(aws_stage_ctx.boto3_session, region)
        load_ec2_key_pairs(
            neo4j_session,
            data, region,
            aws_stage_ctx.current_aws_account_id,
    ...
    cleanup_ec2_key_pairs(neo4j_session, aws_stage_ctx.graph_job_parameters)
