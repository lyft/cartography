...
def load_elasticbeanstalk_applications(
    ...
    for application in data:
        ...
        load_elasticbeanstalk_versions(neo4j_session,
                                       application["ApplicationArn"],
                                       application['VersionsList'],
                                       current_aws_account_id,
                                       aws_update_tag, )

        load_elasticbeanstalk_enviroments(neo4j_session,
                                          application["ApplicationArn"],
...
def sync_elastic_bean_stalk(
    ...
    load_elasticbeanstalk_applications(neo4j_session, applications_data, current_aws_account_id,
                                       aws_update_tag)
