...
CREATE INDEX IF NOT EXISTS FOR (n:AWSEventBridgeRule) ON ) ON (n.n.id);
...
CREATE INDEX IF NOT EXISTS FOR (n:GCPCloudRunService(id);
...
CREATE INDEX IF NOT EXISTS FOR (n:AzureFailoverGroup(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureElasticPool(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureSQLDatabase(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureReplicationLink(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureDatabaseThreatDetectionPolicy(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureRestorePoint(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureTransparentDataEncryption(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureVirtualMachine(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureDataDisk(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureDisk(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureSnapshot(id);
CREATE INDEX IF NOT EXISTS FOR (n:GCPDomain(id);
CREATE INDEX IF NOT EXISTS FOR (n:AzureCluster(id);
