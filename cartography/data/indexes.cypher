...
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkApplication) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkApplication) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkApplication) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkEnvironment) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkEnvironment) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkEnvironment) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkVersion) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkVersion) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:ElasticBeanStalkVersion) ON (n.lastupdated);
