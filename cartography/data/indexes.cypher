...
CREATE INDEX ON :GCPGlobalBackendService(id);
CREATE INDEX ON :GCPRegionalBackendService(id);
CREATE INDEX ON :GCPGlobalUrlMap(id);
CREATE INDEX ON :GCPRegionalUrlMap(id);
