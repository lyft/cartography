...
CREATE INDEX ON :AzureServer(id);
...
CREATE INDEX ON :AzureDatabase(id);
CREATE INDEX ON :ReplicationLink(id);
CREATE INDEX ON :DatabaseThreatDetectionPolicy(id);
CREATE INDEX ON :RestorePoint(id);
CREATE INDEX ON :TransparentDataEncryption(id);
