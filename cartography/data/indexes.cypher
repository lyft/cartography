...
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeUser) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeUser) ON (n.email);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeUser) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeDevice) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeDevice) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeDevice) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeDeviceGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeDeviceGroup) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodeDeviceGroup) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodePolicy) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:HexnodePolicy) ON (n.lastupdated);
