...
CREATE INDEX IF NOT EXISTS FOR (n:HiBobDepartment) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:HiBobDepartment) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:HiBobEmployee) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:HiBobEmployee) ON (n.email);
CREATE INDEX IF NOT EXISTS FOR (n:HiBobEmployee) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:Human) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:Human) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:Human) ON (n.email);
CREATE INDEX IF NOT EXISTS FOR (n:Human) ON (n.lastupdated);
