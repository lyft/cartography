...
CREATE INDEX ON :AWSTransitGateway(tgw_id);
...
CREATE INDEX ON :EC2Route(id);
CREATE INDEX ON :EC2RouteTable(id);
CREATE INDEX ON :EC2RouteTableAssociation(id);
