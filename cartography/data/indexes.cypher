...
CREATE INDEX IF NOT EXISTS FOR (n:GCPSpannerInstance) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:GCPSpannerInstanceConfig) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:GCPSpannerInstanceBackup) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:GCPSpannerInstanceDatabase) ON (n.name);
