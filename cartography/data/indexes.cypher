...
CREATE INDEX IF NOT EXISTS FOR (n:KandjiDevice) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:KandjiDevice) ON (n.serial_number);
CREATE INDEX IF NOT EXISTS FOR (n:KandjiDevice) ON (n.lastupdated);
