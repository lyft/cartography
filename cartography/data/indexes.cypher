...
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudOrganization) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudOrganization) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudUser) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudUser) ON (n.email);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudUser) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudApplication) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudApplication) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudAddon) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:CleverCloudAddon) ON (n.lastupdated);
