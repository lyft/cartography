...
CREATE INDEX ON :GCPIAMRole(id);
CREATE INDEX ON :GCPIAMWorkloadidentitypool(id);
CREATE INDEX ON :GCPIAMWorloadidentitypoolprovider(id);
CREATE INDEX ON :GCPIAMServiceAccount(id);
