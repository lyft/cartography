...
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngress) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngress) ON (n.name);
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngress) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngressRule) ON (n.ingress_uid, n.host);
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngressRule) ON (n.lastupdated);
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngressRuleHttpPath) ON (n.ingress_uid, n.host, n.path, n.path_type);
CREATE INDEX IF NOT EXISTS FOR (n:KubernetesIngressRuleHttpPath) ON (n.lastupdated);
