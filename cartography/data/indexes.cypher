...
CREATE INDEX IF NOT EXISTS FOR (n:CloudWatchLogGroup) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:CloudWatchLogGroup) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:CloudWatchLogGroup) ON (n.lastupdated);
...
CREATE INDEX IF NOT EXISTS FOR (n:FlowLog) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:FlowLog) ON (n.lastupdated);
...
CREATE INDEX IF NOT EXISTS FOR (n:ServerCertificate) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:ServerCertificate) ON (n.arn);
CREATE INDEX IF NOT EXISTS FOR (n:ServerCertificate) ON (n.lastupdated);
