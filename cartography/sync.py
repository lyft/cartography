...
import cartography.intel.hexnode
...
def build_default_sync() -> Sync:
    ...
    sync.add_stages([
        ...
        # WIP        ('aws', cartography.intel.aws.start_aws_ingestion),
        # WIP        ('azure', cartography.intel.azure.start_azure_ingestion),
        # WIP        ('crowdstrike', cartography.intel.crowdstrike.start_crowdstrike_ingestion),
        # WIP        ('gcp', cartography.intel.gcp.start_gcp_ingestion),
        # WIP        ('gsuite', cartography.intel.gsuite.start_gsuite_ingestion),
        # WIP        ('crxcavator', cartography.intel.crxcavator.start_extension_ingestion),
        # WIP        ('cve', cartography.intel.cve.start_cve_ingestion),
        # WIP        ('oci', cartography.intel.oci.start_oci_ingestion),
        # WIP        ('okta', cartography.intel.okta.start_okta_ingestion),
        # WIP        ('github', cartography.intel.github.start_github_ingestion),
        # WIP        ('digitalocean', cartography.intel.digitalocean.start_digitalocean_ingestion),
        # WIP        ('kubernetes', cartography.intel.kubernetes.start_k8s_ingestion),
        ('hexnode', cartography.intel.hexnode.start_hexnode_ingestion),
